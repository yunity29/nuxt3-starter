...
function stripCommentsAndStrings(code) {
  return stripLiteral(code, true).replace(regexRE, 'new RegExp("")');
}
...
export { stripCommentsAndStrings as a, dedupeImports as b, toExports as c, defineUnimportPreset as d, excludeRE as e, toTypeDeclrationItems as f, toTypeDeclrationFile as g, getString as h, importAsRE as i, getMagicString as j, addImportToCode as k, matchRE as m, normalizeImports as n, separatorRE as s, toImports as t, vueTemplateAddon as v };
